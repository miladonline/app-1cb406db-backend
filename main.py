...
async def _list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="say_hello",
            title="Say Hello",
            description="Generate a friendly hello world greeting with optional custom name",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
    ...
    if tool_name == "say_hello":
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"Hello, {name}! Welcome to the hello world app. Interact with the component below.",
                )
            ],
            structuredContent={
